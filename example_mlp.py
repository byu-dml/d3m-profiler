...
for _file in files:
    ...
    if (balanced):
        X_syn = dfs[dfs['datasetName'].eq('SYNTHETIC')].drop(['datasetName', type_column], axis=1)
        y_syn = dfs[dfs['datasetName'].eq('SYNTHETIC')][type_column]

        X_organ = dfs[dfs['datasetName'] != 'SYNTHETIC'].drop(['datasetName', type_column], axis=1)
        y_organ = dfs[dfs['datasetName'] != 'SYNTHETIC'][type_column]
