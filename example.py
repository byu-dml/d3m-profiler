...
file_to_save = 'rf_simon_mlp_unbal_0.csv'
...
np.random.seed(15)
model_combined = MetaSimon(data_path=data_path, embed_data_path=embed_path, model_meta=model_meta, model_both=model_both, balance=False, split_type=split_type, seed=np.random.randint(25,size=5)[0])
